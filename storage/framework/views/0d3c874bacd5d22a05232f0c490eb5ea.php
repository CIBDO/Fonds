<section>
    <header>
        ...
        <p class="mt-1 text-sm text-gray-600">
            <?php echo e(__("Mettez à jour les informations de profil et l'adresse e-mail de votre compte.")); ?>
            ...
            <?php if($user instanceof \Illuminate\Contracts\Auth\MustVerifyEmail && ! $user->hasVerifiedEmail()): ?>
                <div>
                    <p class="text-sm mt-2 text-gray-800">
                        <?php echo e(__('Votre adresse e-mail  pas vérifiée.')); ?>


                        <button form="send-verification" class="underline text-sm text-gray-600 hover:text-gray-900 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                            <?php echo e(__('Cliquez ici pour renvoyer e-mail de vérification.')); ?>
...
<?php endif; ?>
            ...
            <?php if(session('status') === 'profile-updated'): ?>
                ...
                ><?php echo e(__('Enregister.')); ?></p>
            <?php endif; ?>
        </div>
    </form>
</section>
<?php /**PATH C:\Users\BDO\Desktop\Fonds\resources\views\profile\partials\update-profile-information-form.blade.php ENDPATH**/ ?>