...
<div class="content container-fluid">
                ...
                <div class="row">
                    ...
                    <a href="<?php echo e(route('demandes-fonds.index')); ?>" class="w-100 text-decoration-none">
                    ...
                    <div class="col-xl-3 col-sm-6 col-12 d-flex">
                        <a href="<?php echo e(route('demandes-fonds.recettes')); ?>" class="w-100 text-decoration-none">
                        <div class="card bg-comman w-100">
                            <div class="card-body">
                                <div class="db-widgets d-flex justify-content-between align-items-center">
                                    <div class="db-info">
                    ...
                    <div class="col-xl-3 col-sm-6 col-12 d-flex">
                        <a href="<?php echo e(route('demandes-fonds.solde')); ?>" class="w-100 text-decoration-none">
                        <div class="card bg-comman w-100">
                            <div class="card-body">
                                <div class="db-widgets d-flex justify-content-between align-items-center">
                                    <div class="db-info">
                    ...
                    <div class="col-xl-3 col-sm-6 col-12 d-flex">
                        <a href="<?php echo e(route('demandes-fonds.situation')); ?>" class="w-100 text-decoration-none">
                        <div class="card bg-comman w-100">
                            <div class="card-body">
                                <div class="db-widgets d-flex justify-content-between align-items-center">
                                    <div class="db-info">
                                        <h6 style="font-size: 18px; color: hsl(210, 79%, 45%); font-weight: bold;">Fonds Reçus</h6>
