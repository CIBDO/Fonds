...
<table class="table table-bordered">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><input type="number" name="fonctionnaires_bcs_salaire_ancien" class="form-control ancien_salaire" value="<?php echo e($previousData->fonctionnaires_bcs_total_courant ?? 0); ?>"></td>
        ...
        <tr>
            ...
            <td><input type="number" name="collectivite_sante_salaire_ancien" class="form-control ancien_salaire" value="<?php echo e($previousData->collectivite_sante_total_courant ?? 0); ?>"></td>
        ...
        <tr>
            ...
            <td><input type="number" name="collectivite_education_salaire_ancien" class="form-control ancien_salaire" value="<?php echo e($previousData->collectivite_education_total_courant ?? 0); ?>"></td>
        ...
        <tr>
            ...
            <td><input type="number" name="personnels_saisonniers_salaire_ancien" class="form-control ancien_salaire" value="<?php echo e($previousData->personnels_saisonniers_total_courant ?? 0); ?>"></td>
        ...
        <tr>
            ...
            <td><input type="number" name="epn_salaire_ancien" class="form-control ancien_salaire" value="<?php echo e($previousData->epn_total_courant ?? 0); ?>"></td>
        ...
        <tr>
            ...
            <td><input type="number" name="ced_salaire_ancien" class="form-control ancien_salaire" value="<?php echo e($previousData->ced_total_courant ?? 0); ?>"></td>
        ...
        <tr>
            ...
            <td><input type="number" name="ecom_salaire_ancien" class="form-control ancien_salaire" value="<?php echo e($previousData->ecom_total_courant ?? 0); ?>"></td>
        ...
        <tr>
            ...
            <td><input type="number" name="cfp_cpam_salaire_ancien" class="form-control ancien_salaire" value="<?php echo e($previousData->cfp_cpam_total_courant ?? 0); ?>"></td>
