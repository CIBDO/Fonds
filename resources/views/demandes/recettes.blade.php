...
<div class="dgtcp-section">
    ...
    <div class="dgtcp-card mb-4">
        ...
        <div class="dgtcp-card-body">
            <form action="{{ route('demandes-fonds.recettes') }}" method="GET" class="dgtcp-filter-form">
                <div class="row g-3">
                    ...
                    <div class="col-lg-3 col-md-6">
                        ...
                        <select name="annee" class="dgtcp-form-control">
    ...
    <!-- Carte statistique DGTCP -->
    <div class="row mb-4">
        <div class="col-xl-4 col-md-6 mx-auto">
            <div class="dgtcp-stats-card primary">
                <div class="dgtcp-stats-content">
                    <div class="dgtcp-stats-info">
                        <div class="dgtcp-stats-title">Recettes Douanières</div>
                        <div class="dgtcp-stats-value">{{ number_format($totalRecettesDouanieres, 0, ',', ' ') }}</div>
                ...
                <div class="dgtcp-stats-footer">
                    ...
                    <span>Total des recettes douanières</span>
                </div>
            </div>
        </div>
    </div>

    <!-- Tableau des recettes DGTCP -->
    <div class="dgtcp-card">
        <div class="dgtcp-card-header">
            <div class="dgtcp-card-title">
                <i class="fas fa-table"></i>
                <span>Recettes Douanières</span>
            </div>
            <div class="dgtcp-card-actions">
                <div class="dgtcp-stats-mini">
                    <span class="dgtcp-stats-value">{{ $demandeFonds->count() }}</span>
                    <span class="dgtcp-stats-label">Recettes</span>
                </div>
            </div>
        </div>
        <div class="dgtcp-card-body">
                    ...
                    <tfoot>
                        <tr class="dgtcp-total-row">
                            <th class="dgtcp-total-cell">
                                <span class="dgtcp-total-label">Total:</span>
                                <span class="dgtcp-total-value" id="total-recettes">{{ number_format($totalRecettesDouanieres, 0, ',', ' ') }}</span>
                            </th>
                            <th colspan="2"></th>
                        </tr>
                    </tfoot>
...
<style>
/* Styles DGTCP pour la vue recettes */
.dgtcp-section {
    padding: 2rem 0;
...
$(document).ready(function() {
    // Configuration DataTable DGTCP pour les recettes
    const table = $('#demandes-table').DataTable({
        ...
        buttons: [
            ...
            },
            {
                ...
                className: 'dt-button',
                title: 'Recettes Douanières DGTCP',
                exportOptions: {
                    columns: ':visible'
                }
            },
    ...
    // Animation de la carte statistique au chargement
    $('.dgtcp-stats-card').css({
        'opacity': '0',
