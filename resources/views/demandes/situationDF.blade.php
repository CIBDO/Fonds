...
<!-- Formulaire de recherche -->
            <form action="{{ route('demandes-fonds.situationDF') }}" method="GET" class="dgtcp-filter-form mb-4">
        <div class="row g-3">
        ...
        <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="dgtcp-stats-card info">
                            ...
                            <div class="dgtcp-stats-content">
                                <div class="dgtcp-stats-label">Montant à Envoyer</div>
            ...
            <div class="dgtcp-table-container">
                ...
                <thead>
                    <tr>
                            ...
                            <th><i class="fas fa-paper-plane"></i> Montant à Envoyer</th>
                ...
                <tbody>
                    ...
                    <tr>
                            ...
                            <td>
                                <div class="dgtcp-cell-content">
                                    <span class="dgtcp-amount info">{{ number_format($demande->solde, 0, ',', ' ') }}</span>
                                    {{-- <small class="dgtcp-currency">F CFA</small> --}}
                                </div>
                            </td>
                            <td>
    ...
    const table = $('#demandes-table').DataTable({
        dom: '<"row"<"col-sm-12 col-md-6"l><"col-sm-12 col-md-6"f>>' +
            ...
            },
            {
                ...
                className: 'dt-button',
                title: 'Situation Demandes de Fonds DGTCP',
                exportOptions: {
                    columns: ':visible'
                }
            },
        ...
        order: [[4, 'desc']], // Trier par mois décroissant
        columnDefs: [
            {
