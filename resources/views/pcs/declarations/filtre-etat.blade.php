                    ...
                    <div class="card-body">
                        <form id="filtreForm" method="GET" action="{{ route('pcs.declarations.declarations.etat-consolide.filtre') }}" target="_blank">
                            ...
                            <div class="row mb-4">
                                <div class="col-md-6">
                                    ...
                                    <select class="form-select @error('programme') is-invalid @enderror"
                                        ...
                                        <option value="UEMOA" {{ old('programme', request('programme')) == 'UEMOA' ? 'selected' : '' }}>
                                            UEMOA
                                        </option>
                                        <option value="AES" {{ old('programme', request('programme')) == 'AES' ? 'selected' : '' }}>
                                            AES
                                        </option>
                                    </select>
                                    @error('programme')
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-md-6">
                                    <label for="bureau_id" class="form-label fw-bold">
        ...
        .then(data => {
            document.getElementById('statsContainer').innerHTML = `
                <div class="row text-center">
                    <div class="col-6">
                        <div class="stat-item">
                            <h3 class="text-primary">${data.total_declarations}</h3>
                            <p class="text-muted mb-0">Total déclarations</p>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="stat-item">
                            <h3 class="text-success">${data.montant_recouvrement}</h3>
                            <p class="text-muted mb-0">Total recouvrements</p>
                        </div>
                    </div>
                </div>
                <hr>
                <div class="row text-center">
                    <div class="col-6">
                        <div class="stat-item">
                            <h3 class="text-warning">${data.montant_reversement}</h3>
                            <p class="text-muted mb-0">Total reversements</p>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="stat-item">
                            <h3 class="text-info">${data.postes_actifs}</h3>
