...
<body>
    ...
    <div class="table-section">
        ...
        <table>
            ...
            <tbody>
                @foreach($recouvrementsParEntite as $entite => $data)
                <tr>
                    <td class="text-left"><strong>{{ $entite }}</strong></td>
    ...
    <div class="table-section">
        ...
        <table>
            ...
            <tbody>
                @foreach($reversementsParEntite as $entite => $data)
                <tr>
                    <td class="text-left"><strong>{{ $entite }}</strong></td>
                    @for($mois = 1; $mois <= 12; $mois++)
                        <td class="text-right">{{ number_format($data['mois'][$mois] ?? 0, 0, ',', ' ') }}</td>
            ...
            <tfoot>
                ...
                <tr class="total-row">
                    ...
                    @for($mois = 1; $mois <= 12; $mois++)
                        <td class="text-right {{ ($totalRecouvrementsMensuel[$mois] ?? 0) - ($totalReversementsMensuel[$mois] ?? 0) > 0 ? 'negative' : 'positive' }}">
