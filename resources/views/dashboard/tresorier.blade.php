...
<div class="content container-fluid">
                ...
                <div class="row">
                    ...
                    <a href="{{route('demandes-fonds.index')}}" class="w-100 text-decoration-none">
                    ...
                    <div class="col-xl-3 col-sm-6 col-12 d-flex">
                        <a href="{{route('demandes-fonds.recettes')}}" class="w-100 text-decoration-none">
                        <div class="card bg-comman w-100">
                            <div class="card-body">
                                <div class="db-widgets d-flex justify-content-between align-items-center">
                                    <div class="db-info">
                    ...
                    <div class="col-xl-3 col-sm-6 col-12 d-flex">
                        <a href="{{route('demandes-fonds.solde')}}" class="w-100 text-decoration-none">
                        <div class="card bg-comman w-100">
                            <div class="card-body">
                                <div class="db-widgets d-flex justify-content-between align-items-center">
                                    <div class="db-info">
                    ...
                    <div class="col-xl-3 col-sm-6 col-12 d-flex">
                        <a href="{{route('demandes-fonds.situation')}}" class="w-100 text-decoration-none">
                        <div class="card bg-comman w-100">
                            <div class="card-body">
                                <div class="db-widgets d-flex justify-content-between align-items-center">
                                    <div class="db-info">
